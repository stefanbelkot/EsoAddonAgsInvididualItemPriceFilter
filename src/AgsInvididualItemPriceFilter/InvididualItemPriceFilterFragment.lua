function AgsInvididualItemPriceFilter.InitInvididualItemPriceFilterFragmentClass()
	...
	local InvididualItemPriceFilterFragment = ValueRangeFilterFragmentBase:Subclass()
	AgsInvididualItemPriceFilter.InvididualItemPriceFilterFragment = InvididualItemPriceFilterFragment

	function InvididualItemPriceFilterFragment:New(...)
		return ValueRangeFilterFragmentBase.New(self, ...)
	end

	function InvididualItemPriceFilterFragment:Initialize(filterId)
	...
	function InvididualItemPriceFilterFragment:ToNearestValue(value)
		return self.steps[value].id
	end

	function InvididualItemPriceFilterFragment:CreateButton(container, i, data)
	...
	function InvididualItemPriceFilterFragment:SetEnabled(enabled)
	...
	return InvididualItemPriceFilterFragment
end
